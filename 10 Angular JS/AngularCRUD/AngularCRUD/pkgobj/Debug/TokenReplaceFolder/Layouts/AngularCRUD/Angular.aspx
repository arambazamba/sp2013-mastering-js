<%@ Assembly Name="AngularCRUD, Version=1.0.0.0, Culture=neutral, PublicKeyToken=d2d331a14688261a" %>
               ...
               <tbody>  
                 <tr ng-repeat="task in tasks">  
                   ...
                   <td><span>  
                     ...
                     <span>  
                       <input type="button" ng-show="editMode" ng-click="editMode = false; updateTask('MyTasks',task)" value="Save"></span></td>  
                   <td>  
                     <div>  
                       <input type="button" ng-click="deleteTask('MyTasks',task,$index)" value="Delete" /></div>  
                   </td>  
                 </tr>  
                 <tr>  
                   <td>  
                     <input type="button" ng-click="addTask('MyTasks')" value="Add" /></td>  
                 </tr>  
               </tbody>  
             </table>  
           </div>  
